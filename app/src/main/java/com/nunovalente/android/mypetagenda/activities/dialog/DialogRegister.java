            ...
            if (!name.isEmpty()) {
                if (!email.isEmpty()) {
                    if (!password.isEmpty() && password.length() >= 6) {
                        ...
                        Toast.makeText(getActivity().getApplicationContext(), "Password must contain at least 6 characters!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(getActivity().getApplicationContext(), "Please fill your email!", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(getActivity().getApplicationContext(), "Please fill your name!", Toast.LENGTH_SHORT).show();
            }
